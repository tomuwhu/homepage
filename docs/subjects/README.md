...
## Korszerű webtechnológiák az oktatásban

### A tárgy ismeratanyaga:
- Számítógép kezelésének alapjai (fejlesztői szemmel)
- JavaScript ES6
- NodeJS
- Vue
- Rest API-k, WS, SSE
...
- [http://nemes.inf.elte.hu](nemes.inf.elte.hu)
- [http://www.cs.bme.hu/acm/](www.cs.bme.hu/acm/)
- [http://www.ioinformatics.org](www.ioinformatics.org)
- [http://logo.inf.elte.hu/](logo.inf.elte.hu)
